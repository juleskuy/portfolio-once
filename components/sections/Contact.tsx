    ...
    <section id="contact" aria-labelledby="contact-heading" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 id="contact-heading" className="text-3xl font-bold text-gray-900 mb-4">Get in Touch</h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {socialLinks.map((link) => (
                ...
                >
                  <svg className="w-5 h-5 text-gray-600 mr-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d={iconPaths[link.icon] || iconPaths.globe} />
                  </svg>
